"""
modifications and adaptations by UMER1S
credit to: https://github.com/alphascriptyt/Discord_Rewrite_Tutorials for base code
"""
...
class Player(commands.Cog):
    ...
    # vote skip currently playing song
    @commands.command()
